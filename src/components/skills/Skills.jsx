  ...
  return (
    <section id="skills" className="my-10">
      ...
      <div className="grid lg:grid-cols-5 xl:grid-cols-8 grid-cols-2 s:grid-cols-2 md:grid-cols-4 lg:gap-3 grid-rows-1 sm:gap-5 gap-2 items-center justify-center mx-16">
        <div className="lg:col-span-1 p-5  border-blue-500 border-4 rounded-tl-3xl rounded-br-3xl h-full w-full bg-blue-400 bg-clip-padding backdrop-blur-sm bg-opacity-10 hover:animate-bounce grid justify-center ">
          <img src={c} />
